        ...
        <div class="container">
            ...
            <div>
                <a href="{{ route('socailite.redirect','vkontakte') }}"
                    class="min-h-[50px] w-fit xl:w-min text-center 2xl:w-fit px-5 flex justify-center items-center rounded-full bg-azure ml-auto xl:ml-0 font-commissioner-400 text-white text-sm sm:text-base">
